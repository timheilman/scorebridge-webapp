...
export const addrs = {
  ...
  bounce: "bounce@simulator.amazonses.com", // SMTP 550 5.1.1 ("Unknown User") also received via (email or) SNS https://docs.aws.amazon.com/ses/latest/dg/monitor-sending-activity-using-notifications.html
